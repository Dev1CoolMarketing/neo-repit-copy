...
export default function Frame_19() {
  return (
    <div className="flex flex-col items-center md:items-start md:flex-row gap-6 md:gap-8 w-full transition-all py-10  p-10  pb-0 md:py-4 md:p-6 bg-[#f5f5f7]">
      <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-3/5 order-1 md:order-1">
        ...
        <p className="text-[#625046] text-base text-xl md:text-lg  mb-4 sm:mb-6 font-normal max-w-md">
          Concentrated autologous molecules that promote hair restoration.
        </p>

        <div className="flex flex-wrap gap-4 sm:gap-6 mt-2">
          <Button
            variant="link"
            className="hover:text-[#625046] text-md md:text-lg  p-0 h-auto font-normal text-[#8a6015] transition-colors"
      ...
      <div className="w-full md:w-2/5 flex justify-center items-center order-1 md:order-2">
        <div
          ...
          style={{
            backgroundImage: "url('/assets/FOLLICULES.png')",
