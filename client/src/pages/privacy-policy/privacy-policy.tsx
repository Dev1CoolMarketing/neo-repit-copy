      ...
      <section className="pt-10 md:pt-14">
        <div className="text-center">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight !text-black">
            {heading ?? `Privacy Policy — ${cfg.domain}`}
          </h1>
          ...
          <li>
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1 text-base font-semibold">
                ...
                <li>
                  Calling <a className="underline" href={telHref}>{cfg.phone}</a> or dialing 711 for Telecommunications Relay Service.
                </li>
                <li>
          ...
          <li>
            <div className="space-y-2">
              ...
              <div>
                ...
                <br />
                <br />
                Phone: <a className="underline" href={telHref}>{cfg.phone}</a> or dial 711 for Telecommunications Relay Service
                <br />
                <br />
