...
import { 
  ArrowRight, ArrowLeft, Check, PlusCircle, Clock, CircleDollarSign, 
  Calendar, ChevronRight, Sparkles, LayoutGrid, Layers
} from "lucide-react";
...
const treatments = [
    ...
    faq: [
      {
        ...
        answer: "The FUE hair transplant procedure typically takes 4-8 hours depending on the number of grafts needed. It's performed as an outpatient procedure, so you can go home the same day."
      },
      {
        question: "Is the procedure painful?",
        answer: "We use local anesthesia, so you'll experience minimal discomfort during the procedure. Most patients report mild soreness for 1-3 days after, which is easily managed with medication."
      },
      {
        question: "When will I see results?",
        answer: "You'll typically see initial growth at 3-4 months, with significant improvements at 6-9 months. Final results are usually visible at 12-18 months as the transplanted hair fully matures."
      },
      {
        question: "Will the results look natural?",
        answer: "Absolutely. Dr. Neo specializes in creating natural-looking hairlines that complement your facial features. Our advanced techniques ensure the transplanted hair grows at the correct angle and density."
      }
    ],
    ...
    faq: [
      {
        ...
        answer: "Most patients benefit from a series of 3-6 sessions spaced 4-6 weeks apart for optimal results. Maintenance sessions every 3-6 months are recommended to sustain improvements."
      },
      {
        question: "Is there any downtime?",
        answer: "Microneedling has minimal downtime. Your scalp may appear red for 24-48 hours after treatment, similar to a mild sunburn. Most patients return to normal activities immediately."
      },
      {
        question: "Can this be combined with other treatments?",
        answer: "Yes, microneedling with growth factors works synergistically with our other treatments. It's especially effective when combined with Injectable Growth Factors or as a maintenance treatment after an FUE transplant."
      },
      {
        question: "Is the treatment painful?",
        answer: "Most patients report minimal discomfort during the procedure, describing it as a light prickling sensation. We apply a topical numbing cream before treatment to ensure your comfort."
      }
    ],
    ...
    faq: [
      {
        ...
        answer: "The treatment delivers a concentration of specialized proteins that send signals to hair follicle cells, activating cellular regeneration and extending the growth phase of the hair cycle. This helps existing hair grow stronger and thicker while potentially activating dormant follicles."
      },
      {
        question: "How many treatments will I need?",
        answer: "Most patients benefit from a series of 3-4 treatments spaced one month apart, followed by maintenance treatments every 3-6 months depending on your response and goals."
      },
      {
        question: "When will I see results?",
        answer: "Most patients notice a reduction in hair shedding within 2-3 weeks and visible improvement in hair thickness and density within 2-3 months as the hair cycle progresses."
      },
      {
        question: "Is this treatment FDA-approved?",
        answer: "Our Injectable Growth Factors treatment uses high-quality, medical-grade components in compliance with all regulatory standards. The procedure is performed as an off-label application of these components, a common practice in advanced medical aesthetics and hair restoration."
      }
    ],
    pricing: "$XXX - $X,XXX per session",
  ...
  },
  {
    ...
    faq: [
      {
        question: "What makes Follicular Hypersomes™ different from other treatments?",
        answer: "Follicular Hypersomes™ utilizes our proprietary liposomal delivery system that enhances penetration of active ingredients into the hair follicle by up to 600% compared to standard topical solutions, resulting in significantly improved effectiveness."
      },
      {
        question: "How is the treatment performed?",
        answer: "The treatment involves a thorough scalp cleansing followed by precise application of our Hypersomes solution. We then use a specialized device to enhance absorption through gentle vibration and thermal energy. The procedure is comfortable and typically takes 30-45 minutes."
      },
      {
        question: "How soon will I see results?",
        answer: "Most patients notice improvements in scalp health within weeks, with visible changes in hair quality and density appearing after 2-3 months of consistent treatment. The best results typically emerge after completing the full recommended course of 4-6 treatments."
      },
      {
        question: "Is this treatment suitable for all types of hair loss?",
        answer: "Follicular Hypersomes™ works best for individuals with thinning hair who still have viable follicles that are dormant or underperforming. It's particularly effective for androgenetic alopecia (pattern hair loss) and stress-related thinning. During your consultation, we'll determine if this treatment is appropriate for your specific condition."
      }
    ],
    pricing: "$XXX - $X,XXX per session",
    timeEstimate: "30-45 minutes per session",
  ...
  },
  {
    ...
    benefits: [
      "Maintain consistent, ongoing hair improvements",
      "Save significantly on regular treatments",
      "Receive personalized attention from our experts",
      "Adjust your treatment plan as your needs change",
      "Access VIP-only treatments and products",
      "Enjoy the convenience of priority scheduling",
    ],
    faq: [
      {
        question: "What's included in the Vigor VIP membership?",
        answer: "Membership includes regular treatments of Injectable Growth Factors, Follicular Hypersomes™, and Microneedling on a customized schedule, quarterly assessment appointments, priority scheduling, exclusive discounts on products and additional services, and direct access to our clinical team for questions and support."
      },
      {
        question: "How much does the membership cost?",
        answer: "We offer several membership tiers starting at $X,XXX per year, with monthly payment options available. During your consultation, we'll help you select the most appropriate tier based on your needs and goals."
      },
      {
        question: "Can I cancel or pause my membership?",
        answer: "Yes, memberships can be paused for up to 3 months per year to accommodate travel or other circumstances. Cancellations are possible with 30 days' notice, though certain benefits and discounts may be prorated or adjusted."
      },
      {
        question: "How do I know if Vigor VIP is right for me?",
        answer: "Vigor VIP is ideal for men who are committed to maintaining their hair health as a long-term priority and who would benefit from regular treatments. It's particularly valuable if you've had a hair transplant and want to maximize and maintain your results, or if you're using non-surgical treatments to manage ongoing hair thinning."
      }
    ],
    pricing: "Memberships starting at $XXX/month",
    timeEstimate: "Varies by selected program",
...
export default function TreatmentsPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
              <div className="w-full lg:w-1/2 order-2 lg:order-1">
                <div className={`transform transition-all duration-1000 ease-out ${isHeroVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`}>
                  ...
                  <p className="text-xl md:text-2xl text-[#625046]/90 mb-8 lg:mb-12 font-normal">
                    Discover our comprehensive range of cutting-edge solutions designed to address all aspects of hair loss and thinning.
                  </p>
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <div className={`transform transition-all duration-1000 ease-out ${isHeroVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`} style={{ transitionDelay: "150ms" }}>
                  <img 
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 md:mb-16">
              <motion.h2 
                ...
                animate={isTreatmentSectionVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
              ...
              <motion.div 
                ...
                animate={isTreatmentSectionVisible ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
                  ...
                  {treatments.map((treatment, index) => (
                    <motion.div
                      ...
                      className={`snap-center shrink-0 w-[85%] max-w-sm rounded-2xl overflow-hidden shadow-lg bg-white transition-all duration-300 ${
                        selectedTreatment.id === treatment.id ? 'ring-2 ring-[#A87B23] ring-opacity-50' : ''
                      }`}
                      initial={{ opacity: 0, x: 50 }}
                      animate={isTreatmentSectionVisible ? 
                        { opacity: 1, x: 0 } : 
                        { opacity: 0, x: 50 }
                      }
                ...
                {treatments.map((treatment, index) => (
                  <motion.div
                    ...
                    className={`rounded-xl p-4 bg-white shadow-sm transition-all duration-300 ${
                      selectedTreatment.id === treatment.id ? 'ring-2 ring-[#A87B23] ring-opacity-50 shadow-md' : ''
                    }`}
                    initial={{ opacity: 0, y: 20 }}
                    animate={isTreatmentSectionVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          <ChevronRight className={`w-4 h-4 ${
                            selectedTreatment.id === treatment.id ? "text-[#A87B23]" : "text-[#625046]/50"
                          }`} />
                        </div>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {treatments.map((treatment, index) => (
                  <motion.div
                    ...
                    animate={isTreatmentSectionVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
              ...
              <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                {treatments.map((treatment, index) => (
                  <motion.div
                    ...
                    animate={isTreatmentSectionVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 15 }}
                    transition={{ duration: 0.4, delay: 0.05 * index }}
                  >
                    <button
                      className="w-full flex items-center gap-6 p-6 text-left transition-all"
                      onClick={() => {
                        setSelectedTreatment(treatment);
                        setExpandedFaq(null);
                        smoothScrollTo("treatment-details");
                    ...
                    >
                      ...
                      <div className="flex items-center shrink-0 gap-8">
                        ...
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${
                          selectedTreatment.id === treatment.id
                            ? "bg-[#A87B23] text-white"
                            : "bg-[#f5f5f7] text-[#625046] group-hover:bg-[#A87B23]/10"
                        }`}>
                          <ChevronRight className="w-4 h-4" />
                        </div>
                      </div>
      ...
      <div id="treatment-details" className="py-16 lg:py-32 scroll-mt-16">
        <div className="container mx-auto px-4">
          <div className="max-w-screen-xl mx-auto">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-6 items-center">
                  <div className="flex items-center text-[#625046]">
                    ...
                    <span className="text-lg">{selectedTreatment.timeEstimate}</span>
                  </div>
                  <div className="flex items-center text-[#625046]">
                    <Calendar className="w-5 h-5 mr-2 text-[#A87B23]" />
                    <span className="text-lg">{selectedTreatment.recoveryTime}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="relative aspect-[21/9] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-16 text-white max-w-2xl">
                    <div className="bg-black/30 backdrop-blur-md rounded-2xl p-8 inline-block">
                      <div className="text-sm font-medium text-[#A87B23] mb-3">EXCLUSIVE TREATMENT</div>
                      <h3 className="text-3xl font-medium mb-4">Experience the Dr. Neo Difference</h3>
                      <p className="text-white/90">
                        Our advanced techniques and personalized care ensure exceptional results and a comfortable experience.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  {!isMobile && (
                    <div className="grid grid-cols-2 gap-8 mt-12 bg-[#faf8f6] p-8 rounded-2xl">
                      <div>
                        <h4 className="text-lg font-medium text-[#A87B23] mb-3">Procedure Time</h4>
                        <p className="text-[#625046] text-2xl">{selectedTreatment.timeEstimate}</p>
                      </div>
                      <div>
                        <h4 className="text-lg font-medium text-[#A87B23] mb-3">Recovery Period</h4>
                        <p className="text-[#625046] text-2xl">{selectedTreatment.recoveryTime}</p>
                      </div>
                    </div>
                  )}
                </motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {selectedTreatment.benefits.map((benefit, index) => (
                      ...
                      >
                        ...
                        <p className="text-[#625046] font-medium text-lg">{benefit}</p>
                      </motion.div>
                    ))}
                  </div>
                </motion.div>
                        ...
                        >
                          ...
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
                            ...
                            <PlusCircle className={`w-5 h-5 ${
                              expandedFaq === index ? "text-white" : "text-[#625046]"
                            }`} />
                          </div>
                        </button>
                        {expandedFaq === index && (
                  ...
                  <div className="p-8 pt-12">
                    ...
                    <div className="mb-8">
                      <div className="flex items-center justify-between mb-4">
                        <span className="text-[#625046] font-medium">Starting Price</span>
                        <span className="text-xl font-medium text-[#A87B23]">{selectedTreatment.pricing}</span>
                      </div>
                      <div className="bg-[#f9f9f9] p-4 rounded-xl">
                        <p className="text-sm text-[#625046]/80">
                          Pricing varies based on individual treatment needs. Schedule a consultation for an accurate quote tailored to your specific requirements.
                        </p>
                      </div>
                    </div>
            ...
            <div className="mt-24 pt-8 border-t border-[#e5e5e5] flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="flex items-center justify-between w-full md:w-auto gap-4">
                <Button
                  ...
                  onClick={() => {
                    const currentIndex = treatments.findIndex(t => t.id === selectedTreatment.id);
                    const prevIndex = currentIndex > 0 ? currentIndex - 1 : treatments.length - 1;
                ...
                <Button
                  ...
                  onClick={() => {
                    const currentIndex = treatments.findIndex(t => t.id === selectedTreatment.id);
                    const nextIndex = currentIndex < treatments.length - 1 ? currentIndex + 1 : 0;
              ...
              {!isMobile && (
                ...
                >
                  <span className="text-[#625046] text-sm">Share this treatment:</span>
                  <div className="flex items-center gap-2">
                    {["Twitter", "Facebook", "Email"].map((platform, i) => (
                      <Button
                        key={platform}
                        variant="ghost"
                        size="sm"
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 p-10 lg:p-16">
                  ...
                  <p className="text-lg text-[#625046]/90 mb-8">
                    Schedule a consultation with our experts to discuss your hair goals and create a personalized treatment plan.
                  </p>
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-medium text-[#625046]">Personalized Assessment</h4>
                        <p className="text-[#625046]/80">Comprehensive evaluation of your hair and scalp condition</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="bg-[#A87B23]/10 rounded-full p-2 shrink-0">
                      ...
                      <div>
                        <h4 className="font-medium text-[#625046]">Custom Treatment Plan</h4>
                        <p className="text-[#625046]/80">Tailored recommendations based on your specific needs</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="bg-[#A87B23]/10 rounded-full p-2 shrink-0">
                      ...
                      <div>
                        <h4 className="font-medium text-[#625046]">Transparent Pricing</h4>
                        <p className="text-[#625046]/80">Clear explanation of costs with no hidden fees</p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-10 space-y-4">
                    <Button 
                      ...
                      onClick={() => window.location.href = "https://calendly.com/drneo/consultation"}
                    >
                      Book Online
                    </Button>
